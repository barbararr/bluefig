...
import 'package:adaptive_design/ui/screens/home/widgets/admin/desktop_add_patient_to_doctor.dart';
...
class _DesktopMainDoctorPageAdminState
  ...
  void _getData() async {
    patient = (await ApiDataProvider().getUser(globals.currentDoctorID));
